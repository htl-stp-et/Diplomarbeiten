...
\input{Textparts/kurzfassung.tex}
...
\cleardoublepage
%% Beiblaetter
\includepdf[pages={1-2}, scale=1]{HTL_RDP_Dokumentation_DA_DE_A4_2022.pdf}
\includepdf[pages={1-2}, scale=1]{HTL_RDP_Dokumentation_DA_EN_A4_2022.pdf}
...
\chapter{Einleitung}
\input{Textparts/main/einleitung.tex}

\chapter{Theoretische Betrachtungen}
\input{Textparts/main/theorie.tex}
%
\chapter{Konstruktion des Prototypen}
\input{Textparts/main/proto.tex}
%

%\chapter{Kostenaufstellung}
%\input{Textparts/main/kostenaufstellung.tex}

\chapter{Zusammenfassung und Ausblick}
\input{Textparts/main/zusammenfassung.tex}

% Ab hier Anhang
\appendix
%\chapter{Bedienungsanleitung}
%\input{Textparts/anhang/betriebsanleitung.tex}

\chapter{Besprechungsprotokolle}
\input{Textparts/anhang/besprechungsprotokolle.tex}

\chapter{Zeitaufstellung}
\input{Textparts/anhang/zeitaufstellung.tex}
...
\input{Textparts/anhang/datenblaetter.tex}
